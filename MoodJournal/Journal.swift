...
struct Journal: View {
    ...
    var body: some View {
        VStack(spacing: -55) {
            ZStack {
                Image("journalbackground 1").resizable().frame(width: 450,height: 250)
                HStack {
...
//            ScrollView {
                ZStack {
                    LinearGradient(gradient: Gradient(colors: [Color.white, Color(red: 205/255, green: 240/255, blue: 213/255)]), startPoint: .top, endPoint: .bottom).frame(height: 200)
                    VStack {
                        HStack {
                            VStack {
